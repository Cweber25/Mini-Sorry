...
def main():
    ...
    totalArr, spaceCounters, emptyCountTotal, slideCount = miniSorry(amount, spaceCounters)
    ...
    print(f"Number of times the slide from space 5 to space 8 was used: {slideCount}")
...
def miniSorry(amount, spaceCounters):
    ...
    slideCount = 0  # Counter for slide usage
    ...
    return totalArr, spaceCounters, emptyCount, slideCount
